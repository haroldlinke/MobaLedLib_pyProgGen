...
import mlpyproggen.PAM02_Main as PAM02
import mlpyproggen.PAM17_Import_a_decode_Macro as PAM17
import mlpyproggen.PAM11_To_Prog_Gen as PAM11
...
def Import_from_ProgGen_Button_Click():
    ...
    return
    PAM02.Button_Pressed_Proc()
    PAM17.Import_From_Prog_Gen()
