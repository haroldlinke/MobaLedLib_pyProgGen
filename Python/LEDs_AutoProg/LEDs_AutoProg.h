...
//
// It was automatically generated by the program PyProgramWorkbook Ver. 3.1.0F      by Hardi
// File creation: 03/16/22 18:48:17
...
#define START_MSG "LEDs_AutoProg Ver 1: Python 03/16/22 18:48:17"
...
const PROGMEM Ext_Addr_T Ext_Addr[] =
         ...
         { // Addr & Typ    InCnt
// Definition of external adressesconst PROGMEM Ext_Addr_T Ext_Addr[] =         { // Addr & Typ    InCnt
           { 100  + S_ONOFF, 1 },      // Excel row 3           { 101  + B_RED,   4 },      // Excel row 4         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_ONOFF      0      // Excel row 3#define INCH_DCC_101_RED        1      // Excel row 4#define INCH_DCC_101_GREEN      2      //     "#define INCH_DCC_102_RED        3      //     "#define INCH_DCC_102_GREEN      4      //     "
...
MobaLedLib_Configuration()
  {
  House(0, 0, 1, 3, ROOM_DARK, ROOM_BRIGHT, ROOM_WARM_W, ROOM_RED                                             /* Excel row 3                                                                                                                                                                                 */  )                                                                                                           /*     "                                                                                                                                                                                       */  DepSignal4_RGB(4, 1, 128)                                                                                   /* Excel row 4                                                                                                                                                                                 */
