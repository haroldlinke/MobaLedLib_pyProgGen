VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Select_Dest_Sheet 
   Caption         =   "Auswahl der Zielseite "
   ClientHeight    =   2784
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   5985
   OleObjectBlob   =   "Select_Dest_Sheet.frx":0000
   ShowModal       =   0   'False
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "Select_Dest_Sheet"
...
'--------------------------------
   Me.Hide
   If Callback_Proc <> "" Then Run Callback_Proc, False
End Sub
...
'----------------------------
   Me.Hide
   If Callback_Proc <> "" Then Run Callback_Proc, True
End Sub
